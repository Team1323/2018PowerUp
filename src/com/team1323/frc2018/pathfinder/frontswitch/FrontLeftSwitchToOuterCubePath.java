...
public class FrontLeftSwitchToOuterCubePath extends PathfinderPath{
	...
	public FrontLeftSwitchToOuterCubePath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (3*Constants.kCubeWidth) - 1.25, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 3.5, Pathfinder.d2r(90))
		};
		super.maxAccel = 8.0;
