...
public class MiddleCubeToFrontLeftSwitchPath extends PathfinderPath{
	...
	public MiddleCubeToFrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 2.5, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 4.25, Pathfinder.d2r(-90)),
