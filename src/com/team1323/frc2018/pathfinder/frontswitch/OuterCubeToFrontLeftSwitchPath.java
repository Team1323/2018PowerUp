...
public class OuterCubeToFrontLeftSwitchPath extends PathfinderPath{
	...
	public OuterCubeToFrontLeftSwitchPath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (3*Constants.kCubeWidth) - 1.75, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 4.0, Pathfinder.d2r(-130)),
