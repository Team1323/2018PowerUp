...
public class FrontRightSwitchPath extends PathfinderPath{
	...
	public FrontRightSwitchPath(){
		super.points = new Waypoint[]{
				...
				new Waypoint(Constants.kRightSwitchCloseCorner.x() - Constants.kRobotHalfLength - 2.0, Constants.kRightSwitchCloseCorner.y() - Constants.kRobotHalfWidth - 1.0, Pathfinder.d2r(0)),
			};
		super.maxAccel = 6.0;
