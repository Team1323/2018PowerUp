...
public class FrontLeftSwitchToMiddleCubePath extends PathfinderPath{
	...
	public FrontLeftSwitchToMiddleCubePath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - (2*Constants.kCubeWidth) - 1.25, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 4.0, Pathfinder.d2r(90))	
		};
		super.maxAccel = 8.0;
