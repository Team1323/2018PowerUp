...
public class FrontLeftSwitchToBottomMiddlePath extends PathfinderPath{
	...
	public FrontLeftSwitchToBottomMiddlePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kLeftSwitchCloseCorner.x() - Constants.ROBOT_HALF_LENGTH - 0.25, Constants.kLeftSwitchCloseCorner.y() + Constants.ROBOT_HALF_WIDTH + 1.0, Pathfinder.d2r(180)),
