...
public class RightmostCubePickupPath extends PathfinderPath{
	...
	public RightmostCubePickupPath(){
		super.points = new Waypoint[]{
			...
			new Waypoint(Constants.kRightSwitchFarCorner.x() + 2.5, Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH + 1.0, Pathfinder.d2r(-90.0)),
			new Waypoint(Constants.kRightSwitchFarCorner.x() + 2.5, Constants.kRightSwitchFarCorner.y() + Constants.ROBOT_HALF_LENGTH, Pathfinder.d2r(-90.0))
		};
