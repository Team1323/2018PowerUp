...
public class RightCubeToLeftScalePath extends PathfinderPath{
	...
	public RightCubeToLeftScalePath(){
		super.points = new Waypoint[]{
			new Waypoint(Constants.kRightSwitchFarCorner.x() + 3.5, Constants.kRightSwitchFarCorner.y() + Constants.kRobotHalfLength - 0.75, Pathfinder.d2r(-45.0)),
			new Waypoint(20.0, 13.5, Pathfinder.d2r(-90)),
			new Waypoint(20.0, 7.5, Pathfinder.d2r(-90)),
